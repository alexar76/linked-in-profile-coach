...
class AppThemes {
  ...
  static ThemeData themeData(AppThemeId id) {
    ...
    return ThemeData(
      ...
      cardTheme: CardThemeData(
        color: p.surface,
        elevation: isPremium ? (isDark ? 0 : 2) : (isDark ? 0 : 1),
        shadowColor: isPremium
            ? p.glowColor.withValues(alpha: isDark ? 0.12 : 0.08)
            : Colors.black.withValues(alpha: isDark ? 0 : 0.06),
  ...
  static final Map<AppThemeId, AppThemePalette> _palettes = {
    ...
    AppThemeId.darkObsidian: const AppThemePalette(
      id: AppThemeId.darkObsidian,
      background: Color(0xFF050508),
      backgroundElevated: Color(0xFF0E0E12),
      surface: Color(0xFF16161C),
      primary: Color(0xFFE8E6E3),
      primaryLight: Color(0xFFF5F3F0),
      primaryDim: Color(0xFF9CA3AF),
      onPrimary: Color(0xFF050508),
      textPrimary: Color(0xFFF8F7F5),
      textSecondary: Color(0xFF9CA3AF),
      accentOrb: Color(0xFF6B7280),
      backdropGradient: [Color(0xFF050508), Color(0xFF0C0C10), Color(0xFF121218)],
      glowColor: Color(0xFFE8E6E3),
    ),
    AppThemeId.darkChampagne: const AppThemePalette(
      id: AppThemeId.darkChampagne,
      background: Color(0xFF12100C),
      backgroundElevated: Color(0xFF1C1812),
      surface: Color(0xFF252018),
      primary: Color(0xFFD4AF37),
      primaryLight: Color(0xFFF0D78C),
      primaryDim: Color(0xFF9A7B2E),
      onPrimary: Color(0xFF12100C),
      textPrimary: Color(0xFFF5EDE0),
      textSecondary: Color(0xFFB8A88A),
      accentOrb: Color(0xFFC9A962),
      backdropGradient: [Color(0xFF12100C), Color(0xFF1A1610), Color(0xFF141210)],
      glowColor: Color(0xFFD4AF37),
    ),
    AppThemeId.darkEmerald: const AppThemePalette(
      id: AppThemeId.darkEmerald,
      background: Color(0xFF060F0C),
      backgroundElevated: Color(0xFF0C1814),
      surface: Color(0xFF122820),
      primary: Color(0xFF34D399),
      primaryLight: Color(0xFF6EE7B7),
      primaryDim: Color(0xFF059669),
      onPrimary: Color(0xFF060F0C),
      textPrimary: Color(0xFFECFDF5),
      textSecondary: Color(0xFF86B8A8),
      accentOrb: Color(0xFF10B981),
      backdropGradient: [Color(0xFF060F0C), Color(0xFF0A1612), Color(0xFF081410)],
      glowColor: Color(0xFF34D399),
    ),
    AppThemeId.lightPlatinum: const AppThemePalette(
      id: AppThemeId.lightPlatinum,
      background: Color(0xFFF4F4F5),
      backgroundElevated: Color(0xFFFFFFFF),
      surface: Color(0xFFFFFFFF),
      primary: Color(0xFF52525B),
      primaryLight: Color(0xFF71717A),
      primaryDim: Color(0xFF3F3F46),
      onPrimary: Color(0xFFFFFFFF),
      textPrimary: Color(0xFF18181B),
      textSecondary: Color(0xFF71717A),
      accentOrb: Color(0xFFA1A1AA),
      backdropGradient: [Color(0xFFFAFAFA), Color(0xFFF4F4F5), Color(0xFFFFFFFF)],
      glowColor: Color(0xFF71717A),
    ),
    AppThemeId.lightChampagne: const AppThemePalette(
      id: AppThemeId.lightChampagne,
      background: Color(0xFFFFFBF5),
      backgroundElevated: Color(0xFFFFFFFF),
      surface: Color(0xFFFFFCF8),
      primary: Color(0xFFC4A574),
      primaryLight: Color(0xFFE8D5A3),
      primaryDim: Color(0xFF9A7B4F),
      onPrimary: Color(0xFFFFFFFF),
      textPrimary: Color(0xFF2C2419),
      textSecondary: Color(0xFF7A6B55),
      accentOrb: Color(0xFFD4AF37),
      backdropGradient: [Color(0xFFFFFBF5), Color(0xFFF8F0E4), Color(0xFFFFFDF9)],
      glowColor: Color(0xFFC4A574),
    ),
  };
  ...
  static List<AppThemeId> get premiumThemes => [

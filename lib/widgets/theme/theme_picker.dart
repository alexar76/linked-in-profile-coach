  ...
  Widget build(BuildContext context) {
    ...
    final content = Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        _ThemeGroup(
          title: l10n.themeGroupPremium,
          ids: AppThemes.premiumThemes,
          selected: selected,
          onSelected: onSelected,
          compact: compact,
          premium: true,
        ...
        Row(
          children: [
            ...
            if (premium) ...[
              ...
              Icon(Icons.diamond_outlined, size: 16, color: context.palette.primaryLight),
            ],
          ],
        ),
...
class _ThemeSwatch extends StatelessWidget {
            ...
            child: Transform.scale(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: selected
                    ? [
                        BoxShadow(
                          color: p.glowColor.withValues(alpha: 0.35),
                          blurRadius: 12,
                          spreadRadius: 1,
                        ),
                      ]
  ...
  String _themeName(AppLocalizations l10n, AppThemeId id) => switch (id) {
        ...
        AppThemeId.darkObsidian => l10n.themeDarkObsidian,
        AppThemeId.darkChampagne => l10n.themeDarkChampagne,
        AppThemeId.darkEmerald => l10n.themeDarkEmerald,
        AppThemeId.lightPlatinum => l10n.themeLightPlatinum,
        AppThemeId.lightChampagne => l10n.themeLightChampagne,
      };
}

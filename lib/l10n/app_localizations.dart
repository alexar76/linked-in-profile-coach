...
abstract class AppLocalizations {
  ...
  /// No description provided for @themeGroupPremium.
  ///
  /// In en, this message translates to:
  /// **'Premium'**
  String get themeGroupPremium;
  ...
  /// No description provided for @themeDarkObsidian.
  ///
  /// In en, this message translates to:
  /// **'Obsidian Platinum'**
  String get themeDarkObsidian;

  /// No description provided for @themeDarkChampagne.
  ///
  /// In en, this message translates to:
  /// **'Champagne Noir'**
  String get themeDarkChampagne;

  /// No description provided for @themeDarkEmerald.
  ///
  /// In en, this message translates to:
  /// **'Emerald Luxe'**
  String get themeDarkEmerald;

  /// No description provided for @themeLightPlatinum.
  ///
  /// In en, this message translates to:
  /// **'Platinum Silk'**
  String get themeLightPlatinum;

  /// No description provided for @themeLightChampagne.
  ///
  /// In en, this message translates to:
  /// **'Champagne Silk'**
  String get themeLightChampagne;
  ...
  /// No description provided for @aiGenOptionsTitle.
  ///
  /// In en, this message translates to:
  /// **'AI generation options'**
  String get aiGenOptionsTitle;

  /// No description provided for @aiGenOptionsSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Tune how the profile is written. Creativity controls model temperature.'**
  String get aiGenOptionsSubtitle;

  /// No description provided for @aiGenFocusLabel.
  ///
  /// In en, this message translates to:
  /// **'Profile goal'**
  String get aiGenFocusLabel;

  /// No description provided for @aiGenFocusJobSearch.
  ///
  /// In en, this message translates to:
  /// **'Job search'**
  String get aiGenFocusJobSearch;

  /// No description provided for @aiGenFocusJobSearchDesc.
  ///
  /// In en, this message translates to:
  /// **'Recruiters, ATS keywords, role fit'**
  String get aiGenFocusJobSearchDesc;

  /// No description provided for @aiGenFocusNetworking.
  ///
  /// In en, this message translates to:
  /// **'Networking'**
  String get aiGenFocusNetworking;

  /// No description provided for @aiGenFocusNetworkingDesc.
  ///
  /// In en, this message translates to:
  /// **'Connections, intros, collaboration'**
  String get aiGenFocusNetworkingDesc;

  /// No description provided for @aiGenFocusThoughtLeadership.
  ///
  /// In en, this message translates to:
  /// **'Thought leadership'**
  String get aiGenFocusThoughtLeadership;

  /// No description provided for @aiGenFocusThoughtLeadershipDesc.
  ///
  /// In en, this message translates to:
  /// **'Authority, insights, audience'**
  String get aiGenFocusThoughtLeadershipDesc;

  /// No description provided for @aiGenFocusFreelance.
  ///
  /// In en, this message translates to:
  /// **'Freelance & clients'**
  String get aiGenFocusFreelance;

  /// No description provided for @aiGenFocusFreelanceDesc.
  ///
  /// In en, this message translates to:
  /// **'Services, outcomes, trust'**
  String get aiGenFocusFreelanceDesc;

  /// No description provided for @aiGenVariantCountLabel.
  ///
  /// In en, this message translates to:
  /// **'Draft variants'**
  String get aiGenVariantCountLabel;

  /// No description provided for @aiGenVariantOne.
  ///
  /// In en, this message translates to:
  /// **'1'**
  String get aiGenVariantOne;

  /// No description provided for @aiGenVariantTwo.
  ///
  /// In en, this message translates to:
  /// **'2'**
  String get aiGenVariantTwo;

  /// No description provided for @aiGenVariantThree.
  ///
  /// In en, this message translates to:
  /// **'3'**
  String get aiGenVariantThree;

  /// No description provided for @aiCreativityLabel.
  ///
  /// In en, this message translates to:
  /// **'Creativity'**
  String get aiCreativityLabel;

  /// No description provided for @aiCreativityHint.
  ///
  /// In en, this message translates to:
  /// **'Lower = factual and consistent. Higher = more varied wording (LLM temperature).'**
  String get aiCreativityHint;

  /// No description provided for @aiGenSkipDialogLabel.
  ///
  /// In en, this message translates to:
  /// **'Don\'t ask again — use these defaults'**
  String get aiGenSkipDialogLabel;

  /// No description provided for @aiGenPrefsSection.
  ///
  /// In en, this message translates to:
  /// **'AI generation defaults'**
  String get aiGenPrefsSection;

  /// No description provided for @aiGenPrefsSectionSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Used when you tap Generate AI (unless you change options in the dialog).'**
  String get aiGenPrefsSectionSubtitle;

  /// No description provided for @aiVariantPickerLabel.
  ///
  /// In en, this message translates to:
  /// **'Variant'**
  String get aiVariantPickerLabel;
  ...
  /// No description provided for @wowHubTitle.
  ///
  /// In en, this message translates to:
  /// **'Coach+ tools'**
  String get wowHubTitle;

  /// No description provided for @wowHubSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Advanced AI workflows: recruiter simulation, job fit, career forecast, A/B headlines, benchmarks.'**
  String get wowHubSubtitle;

  /// No description provided for @wowRecruiterTitle.
  ///
  /// In en, this message translates to:
  /// **'Recruiter simulator'**
  String get wowRecruiterTitle;

  /// No description provided for @wowRecruiterSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Screening questions, interview verdict, section heat-map'**
  String get wowRecruiterSubtitle;

  /// No description provided for @wowRecruiterIntro.
  ///
  /// In en, this message translates to:
  /// **'An AI recruiter reviews your profile for your target role and asks the tough questions.'**
  String get wowRecruiterIntro;

  /// No description provided for @wowRunSimulation.
  ///
  /// In en, this message translates to:
  /// **'Run simulation'**
  String get wowRunSimulation;

  /// No description provided for @wowHeatmapTitle.
  ///
  /// In en, this message translates to:
  /// **'Section heat-map'**
  String get wowHeatmapTitle;

  /// No description provided for @wowHeatmapEmpty.
  ///
  /// In en, this message translates to:
  /// **'No heat-map data yet.'**
  String get wowHeatmapEmpty;

  /// No description provided for @wowHeatStrong.
  ///
  /// In en, this message translates to:
  /// **'Strong'**
  String get wowHeatStrong;

  /// No description provided for @wowHeatNeutral.
  ///
  /// In en, this message translates to:
  /// **'Neutral'**
  String get wowHeatNeutral;

  /// No description provided for @wowHeatWeak.
  ///
  /// In en, this message translates to:
  /// **'Weak'**
  String get wowHeatWeak;

  /// No description provided for @wowQuestionsTitle.
  ///
  /// In en, this message translates to:
  /// **'Questions they\'d ask'**
  String get wowQuestionsTitle;

  /// No description provided for @wowVerdictInterview.
  ///
  /// In en, this message translates to:
  /// **'Would interview'**
  String get wowVerdictInterview;

  /// No description provided for @wowVerdictMaybe.
  ///
  /// In en, this message translates to:
  /// **'Maybe'**
  String get wowVerdictMaybe;

  /// No description provided for @wowVerdictPass.
  ///
  /// In en, this message translates to:
  /// **'Would pass'**
  String get wowVerdictPass;

  /// No description provided for @wowLocalFallbackHint.
  ///
  /// In en, this message translates to:
  /// **'LLM off or error — heuristic simulation used.'**
  String get wowLocalFallbackHint;

  /// No description provided for @wowJobFitTitle.
  ///
  /// In en, this message translates to:
  /// **'Job-fit match'**
  String get wowJobFitTitle;

  /// No description provided for @wowJobFitSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Paste a job posting — get match %, gaps, tailored edits'**
  String get wowJobFitSubtitle;

  /// No description provided for @wowJobFitIntro.
  ///
  /// In en, this message translates to:
  /// **'Compare your profile to a specific vacancy. Saves a tailored snapshot you can restore later.'**
  String get wowJobFitIntro;

  /// No description provided for @wowJobFitPasteLabel.
  ///
  /// In en, this message translates to:
  /// **'Job description'**
  String get wowJobFitPasteLabel;

  /// No description provided for @wowJobFitPasteHint.
  ///
  /// In en, this message translates to:
  /// **'Paste the full job posting text or URL content…'**
  String get wowJobFitPasteHint;

  /// No description provided for @wowJobFitAnalyze.
  ///
  /// In en, this message translates to:
  /// **'Analyze fit'**
  String get wowJobFitAnalyze;

  /// No description provided for @wowJobFitMatch.
  ///
  /// In en, this message translates to:
  /// **'Role match'**
  String get wowJobFitMatch;

  /// No description provided for @wowJobFitMissing.
  ///
  /// In en, this message translates to:
  /// **'Missing keywords'**
  String get wowJobFitMissing;

  /// No description provided for @wowJobFitGaps.
  ///
  /// In en, this message translates to:
  /// **'Gap list'**
  String get wowJobFitGaps;

  /// No description provided for @wowJobFitSaveSnapshot.
  ///
  /// In en, this message translates to:
  /// **'Save tailored snapshot'**
  String get wowJobFitSaveSnapshot;

  /// No description provided for @wowJobFitApplyAi.
  ///
  /// In en, this message translates to:
  /// **'Apply edits to AI draft'**
  String get wowJobFitApplyAi;

  /// No description provided for @wowJobFitSnapshotSaved.
  ///
  /// In en, this message translates to:
  /// **'Tailored snapshot saved (History on LinkedIn tab).'**
  String get wowJobFitSnapshotSaved;

  /// No description provided for @wowJobFitAppliedAi.
  ///
  /// In en, this message translates to:
  /// **'Tailored text applied to AI sections.'**
  String get wowJobFitAppliedAi;

  /// No description provided for @wowCareerTitle.
  ///
  /// In en, this message translates to:
  /// **'Career what-if'**
  String get wowCareerTitle;

  /// No description provided for @wowCareerSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Timeline + 1/3/5 year forecast with sliders'**
  String get wowCareerSubtitle;

  /// No description provided for @wowCareerIntro.
  ///
  /// In en, this message translates to:
  /// **'See your experience timeline and AI forecast for realistic next steps.'**
  String get wowCareerIntro;

  /// No description provided for @wowCareerSeniorSlider.
  ///
  /// In en, this message translates to:
  /// **'Extra senior experience'**
  String get wowCareerSeniorSlider;

  /// No description provided for @wowCareerYears.
  ///
  /// In en, this message translates to:
  /// **'years'**
  String get wowCareerYears;

  /// No description provided for @wowCareerCourseLabel.
  ///
  /// In en, this message translates to:
  /// **'Course / certification (optional)'**
  String get wowCareerCourseLabel;

  /// No description provided for @wowCareerCourseHint.
  ///
  /// In en, this message translates to:
  /// **'e.g. AWS Solutions Architect'**
  String get wowCareerCourseHint;

  /// No description provided for @wowCareerForecast.
  ///
  /// In en, this message translates to:
  /// **'Run forecast'**
  String get wowCareerForecast;

  /// No description provided for @wowCareerSkills.
  ///
  /// In en, this message translates to:
  /// **'Skills to add'**
  String get wowCareerSkills;

  /// No description provided for @wowHeadlineAbTitle.
  ///
  /// In en, this message translates to:
  /// **'Headline A/B'**
  String get wowHeadlineAbTitle;

  /// No description provided for @wowHeadlineAbSubtitle.
  ///
  /// In en, this message translates to:
  /// **'5 ranked variants with ATS, hook, uniqueness scores'**
  String get wowHeadlineAbSubtitle;

  /// No description provided for @wowHeadlineAbIntro.
  ///
  /// In en, this message translates to:
  /// **'Generate headline options and pick the winner from a scored leaderboard.'**
  String get wowHeadlineAbIntro;

  /// No description provided for @wowHeadlineGenerate.
  ///
  /// In en, this message translates to:
  /// **'Generate & rank'**
  String get wowHeadlineGenerate;

  /// No description provided for @wowHeadlineAbLegend.
  ///
  /// In en, this message translates to:
  /// **'Scores: ATS fit, readability, hook power, uniqueness vs clichés.'**
  String get wowHeadlineAbLegend;

  /// No description provided for @wowHeadlineBest.
  ///
  /// In en, this message translates to:
  /// **'Best'**
  String get wowHeadlineBest;

  /// No description provided for @wowHeadlineReadability.
  ///
  /// In en, this message translates to:
  /// **'Readability'**
  String get wowHeadlineReadability;

  /// No description provided for @wowHeadlineHook.
  ///
  /// In en, this message translates to:
  /// **'Hook'**
  String get wowHeadlineHook;

  /// No description provided for @wowHeadlineUnique.
  ///
  /// In en, this message translates to:
  /// **'Unique'**
  String get wowHeadlineUnique;

  /// No description provided for @wowHeadlineUse.
  ///
  /// In en, this message translates to:
  /// **'Use this'**
  String get wowHeadlineUse;

  /// No description provided for @wowHeadlineApplied.
  ///
  /// In en, this message translates to:
  /// **'Headline applied to AI draft.'**
  String get wowHeadlineApplied;

  /// No description provided for @wowBenchmarkTitle.
  ///
  /// In en, this message translates to:
  /// **'You vs median'**
  String get wowBenchmarkTitle;

  /// No description provided for @wowBenchmarkSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Radar benchmark for your target role'**
  String get wowBenchmarkSubtitle;

  /// No description provided for @wowBenchmarkIntro.
  ///
  /// In en, this message translates to:
  /// **'Compare your profile metrics to typical medians for your role (AI-estimated benchmarks).'**
  String get wowBenchmarkIntro;

  /// No description provided for @wowBenchmarkRun.
  ///
  /// In en, this message translates to:
  /// **'Compare to median'**
  String get wowBenchmarkRun;

  /// No description provided for @wowBenchmarkYou.
  ///
  /// In en, this message translates to:
  /// **'You'**
  String get wowBenchmarkYou;

  /// No description provided for @wowBenchmarkMedian.
  ///
  /// In en, this message translates to:
  /// **'Median'**
  String get wowBenchmarkMedian;

  /// No description provided for @profilesSwitcherLabel.
  ///
  /// In en, this message translates to:
  /// **'Profile'**
  String get profilesSwitcherLabel;
  ...
  /// No description provided for @profilesSectionSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Switch between candidates — each profile has its own LinkedIn data, AI drafts, and scores.'**
  ...
  /// No description provided for @profilesAddConfirm.
  ///
  /// In en, this message translates to:
  /// **'Create'**
  String get profilesAddConfirm;
  ...
  /// No description provided for @profilesRenameAction.
  ///
  /// In en, this message translates to:
  /// **'Rename'**
  String get profilesRenameAction;
  ...
  /// No description provided for @profilesCannotDeleteLast.
  ///
  /// In en, this message translates to:
  /// **'You need at least one profile.'**
  String get profilesCannotDeleteLast;

  /// No description provided for @profilesNameHint.
  ///
  /// In en, this message translates to:
  /// **'e.g. Alex Morgan — Senior PM'**
  ...
  /// No description provided for @snackProfileSwitched.
  ///
  /// In en, this message translates to:
  /// **'Switched to {name}'**
  ...
  /// No description provided for @marketplaceCatalogTitle.
  ///
  /// In en, this message translates to:
  /// **'Career Marketplace'**
  String get marketplaceCatalogTitle;

  /// No description provided for @marketplaceTopUp.
  ///
  /// In en, this message translates to:
  /// **'Top up credits in browser wallet'**
  String get marketplaceTopUp;

  /// No description provided for @marketplaceCategoryCareer.
  ///
  /// In en, this message translates to:
  /// **'Career capabilities'**
  String get marketplaceCategoryCareer;

  /// No description provided for @marketplacePrivacyNotice.
  ///
  /// In en, this message translates to:
  /// **'Your profile never leaves this device. Marketplace delivers capabilities to you — not your data outward.'**
  String get marketplacePrivacyNotice;

  /// No description provided for @aiProviderAimarket.
  ///
  /// In en, this message translates to:
  /// **'AI Market'**
  String get aiProviderAimarket;

  /// No description provided for @aiProviderAimarketHint.
  ///
  /// In en, this message translates to:
  /// **'Pay-per-call marketplace. Wallet-based, no API key. Top up credits in Marketplace tab.'**
  String get aiProviderAimarketHint;

  /// No description provided for @aiProviderAimarketSetupHint.
  ///
  /// In en, this message translates to:
  /// **'AI Market: modelmarket.dev — connects to decentralized marketplace. Top up credits first.'**
